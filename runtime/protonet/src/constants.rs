...
pub mod time {
	...
	// NOTE: Protonet runtime runs 8x faster than the xxnetwork one
	// This means that a session/epoch is 1 hours instead of 8 hours
	// and that the era is 3 hours instead of 1 day
