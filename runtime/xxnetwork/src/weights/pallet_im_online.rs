...
impl<T: frame_system::Config> pallet_im_online::WeightInfo for WeightInfo<T> {
	...
	fn validate_unsigned_and_then_heartbeat(k: u32, e: u32, ) -> Weight {
		Weight::from_ref_time(89_629_000 as u64)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(145_000 as u64).saturating_mul(k as u64))
			// Standard Error: 2_000
			.saturating_add(Weight::from_ref_time(757_000 as u64).saturating_mul(e as u64))
