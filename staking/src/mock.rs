...
impl CustodianHandler<AccountId, Balance> for CustodianHandlerMock {
...
pub type CmixHash = <Test as frame_system::Config>::Hash;
pub(crate) type StakingCall = crate::Call<Test>;
pub(crate) type TestRuntimeCall = <Test as frame_system::Config>::Call;

impl ValidatorPrefs<CmixHash> {
    pub fn default_with_hash(cmix_root: CmixHash) -> Self {
        Self {
            cmix_root,
            ..Self::default()
        }
...
impl Default for ExtBuilder {
    fn default() -> Self {
        Self {
            ...
            validator_min_bond: Default::default(),
        }
    }
}
...
impl ExtBuilder {
    ...
    pub fn min_bond(mut self, min_bond: Balance) -> Self {
        self.validator_min_bond = min_bond;
        self
    }
    ...
    pub fn build(self) -> sp_io::TestExternalities {
        ...
        if self.has_stakers {
            ...
            let status_41 = if self.validator_pool {
                StakerStatus::<CmixHash, AccountId>::Validator(ValidatorPrefs::default_with_hash(CmixHash::repeat_byte(41 as u8)))
            } else {
                StakerStatus::<CmixHash, AccountId>::Idle
            };
            ...
            stakers = vec![
                ...
                (
                    ...
                    10,
                    balance_factor * 1000,
                    StakerStatus::<CmixHash, AccountId>::Validator(
                        ValidatorPrefs::default_with_hash(CmixHash::repeat_byte(11 as u8)),
                    ),
                ),
                (
                    21,
                    ...
                    stake_21,
                    StakerStatus::<CmixHash, AccountId>::Validator(
                        ValidatorPrefs::default_with_hash(CmixHash::repeat_byte(21 as u8)),
                    ),
                ),
                (
                    31,
                    ...
                    stake_31,
                    StakerStatus::<CmixHash, AccountId>::Validator(
                        ValidatorPrefs::default_with_hash(CmixHash::repeat_byte(31 as u8)),
                    ),
                ),
                ...
                (
                    ...
                    100,
                    balance_factor * 500,
                    StakerStatus::<CmixHash, AccountId>::Nominator(nominated),
                ),
            ];
        }
        let _ = staking::GenesisConfig::<Test> {
            ...
            validator_min_bond: self.validator_min_bond,
            ..Default::default()
        }
        .assimilate_storage(&mut storage);
...
pub(crate) fn bond_validator(stash: AccountId, ctrl: AccountId, val: Balance) {
    ...
    assert_ok!(Staking::validate(
        Origin::signed(ctrl),
        // this will truncate for stash accountIDs larger than 255 and may cause a ValidatorCmixIdNotUnique error
        ValidatorPrefs::default_with_hash(CmixHash::repeat_byte(stash as u8)) 
    ));
}
...
pub(crate) struct Staker { pub stash: AccountId, pub ctrl: AccountId }
